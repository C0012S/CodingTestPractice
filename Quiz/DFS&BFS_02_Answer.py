...
<문제> 미로 탈출 : 문제 조건
난이도 : 1.5 | 풀이 시간 : 30 분 | 시간 제한 : 1 초 | 메모리 제한 128MB
입력 조건 : 첫째 줄에 두 정수 N, M(4 <= N, M <= 200)이 주어집니다. 다음 N 개의 줄에는 각각 M 개의 정수(0 혹은 1)로 미로의 정보가 주어집니다. 각각의 수들은 공백 없이 붙어서 입력으로 제시됩니다. 또한 시작 칸과 마지막 칸은 항상 1입니다.
